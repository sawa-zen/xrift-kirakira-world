...
export const NEWTYPE_THEMES = {
  machu: {
    ...
    cones: [
      ...
      { position: [0, 0, -18], scale: [2, 2, 0.2], color: 0x37817F, streamSpeed: 30.0, noiseStrength: 0.1, rotatingSpeed: -0.4, uvScaleX: 60.0, uvScaleY: 30.0, blending: 2, startY: 0.4, endY: 0.7, gaussian: true },
      { position: [0, 0, 1], scale: [3, 3, 1.5], color: 0x2CC1A3, streamSpeed: 40.0, noiseStrength: 0.1, rotatingSpeed: -0.2, uvScaleX: 60.0, uvScaleY: 60.0, blending: 2, startY: 0.3, endY: 0.7, gaussian: false },
      ...
      { position: [0, 0, -18], scale: [0.5, 0.5, 0.1], color: 0xFE91CE, streamSpeed: 8.0, noiseStrength: 0.3, rotatingSpeed: -0.2, uvScaleX: 20.0, uvScaleY: 20.0, blending: 1, startY: 0.5, endY: 0.3, gaussian: true },
  ...
  nyaan: {
    ...
    cones: [
      ...
      { position: [0, 0, -18], scale: [2, 2, 0.2], color: 0x9370db, streamSpeed: 30.0, noiseStrength: 0.1, rotatingSpeed: -0.4, uvScaleX: 60.0, uvScaleY: 30.0, blending: 2, startY: 0.4, endY: 0.7, gaussian: true },
      ...
      { position: [0, 0, -14], scale: [0.35, 0.35, 0.2], color: 0xffd700, streamSpeed: 12.0, noiseStrength: 0.5, rotatingSpeed: 0.3, uvScaleX: 10.0, uvScaleY: 25.0, blending: 2, startY: 0.3, endY: 0.35, gaussian: true },
      { position: [0, 0, -18], scale: [0.5, 0.5, 0.1], color: 0xf18904, streamSpeed: 8.0, noiseStrength: 0.3, rotatingSpeed: -0.2, uvScaleX: 20.0, uvScaleY: 20.0, blending: 1, startY: 0.5, endY: 0.3, gaussian: true },
      { position: [0, 0, 1], scale: [0.4, 0.4, 1.0], color: 0xffd700, streamSpeed: 18.0, noiseStrength: 0.05, rotatingSpeed: 0.5, uvScaleX: 50.0, uvScaleY: 25.0, blending: 2, startY: 0.4, endY: 0.7, gaussian: true },
      { position: [0, 0, 1], scale: [0.5, 0.5, 1.0], color: 0xfab95b, streamSpeed: 19.0, noiseStrength: 0.05, rotatingSpeed: -0.3, uvScaleX: 50.0, uvScaleY: 30.0, blending: 2, startY: 0.2, endY: 0.7, gaussian: true },
    ],
  },
} as const
